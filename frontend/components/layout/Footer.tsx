    ...
    <>
      <footer className="w-full bg-footer-background flex-shrink-0 p-8 flex flex-row ">
        ...
        <FooterTextComponent header="Kontakt">
          <span>
            <p className="text-text-on-footer-light">Peakontor: Tallinnas</p>
          </span>
          <p className="text-text-on-footer-dark">
            Vaike- Ameerika 1, 11415 Tallinn
          </p>
        ...
        <FooterTextComponent header=" ">
          <span>
            <p className="text-text-on-footer-light">Harukontor: Võrus</p>
          </span>
